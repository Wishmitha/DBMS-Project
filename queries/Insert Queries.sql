...
INSERT INTO `exacutor`.`sports`(`sport_name`,`logo`,`team`,`description`,`created_at`,`updated_at`)VALUES('Cricket','https://scontent-sit4-1.xx.fbcdn.net/v/t1.0-9/16807_10154809697690005_2893730701933941583_n.jpg?oh=ee8549938d3c72423dd1680ce029a207&oe=58F9A942','University of Moratuwa','Official cricket team of University of Moratuwa','2016/12/13','2016/12/13');

=============
competitions
=============

INSERT INTO `exacutor`.`competitions`(`competition_name`,`logo`,`host`,`description`,`created_at`,`updated_at`)VALUES('GSOC','https://developers.google.com/open-source/gsoc/images/gsoc2016-sun-373x373.png','Google','Google Summer of Code is a global program focused on bringing more student developers into open source software development.','2016/12/13','2016/12/13');
...
INSERT INTO `exacutor`.`extra_curricular_activities`(`type`,`sp_id`,`comp_id`,`clb_id`,`defined_effort`,`created_at`,`updated_at`) VALUES('Competition',null,1,null,30,'2016/12/13','2016/12/13');
...
INSERT INTO `exacutor`.`student_activity`(`stu_id`,`act_id`,`role`,`effort`,`joined`,`is_validated`,`description`,`created_at`,`updated_at`) VALUES (140253,1,'Web Developer',12,'2015/03/30',0,'Developed "Are you Ready 2016" official website and "Link-Rotaract" promotion page','2016/12/01','2016/12/01');

INSERT INTO `exacutor`.`student_activity`(`stu_id`,`act_id`,`role`,`effort`,`joined`,`is_validated`,`description`,`created_at`,`updated_at`) VALUES (140253,4,'Participant',25,'2016/03/25',1,'Completed Project "X-Spectro" of WSO2 successfully','2016/12/13','2016/12/13');

INSERT INTO `exacutor`.`student_activity`(`stu_id`,`act_id`,`role`,`effort`,`joined`,`is_validated`,`description`,`created_at`,`updated_at`) VALUES (140392,1,'Member',5,'2016/05/30',0,null,'2016/12/01','2016/12/01');

INSERT INTO `exacutor`.`student_activity`(`stu_id`,`act_id`,`role`,`effort`,`joined`,`is_validated`,`description`,`created_at`,`updated_at`) VALUES (140392,2,'Panelist',12,'2015/03/30',0,null,'2016/12/01','2016/12/01');

INSERT INTO `exacutor`.`student_activity`(`stu_id`,`act_id`,`role`,`effort`,`joined`,`is_validated`,`description`,`created_at`,`updated_at`) VALUES (140331,2,'Member',7,'2015/10/30',1,null,'2016/12/01','2016/12/01');

INSERT INTO `exacutor`.`student_activity`(`stu_id`,`act_id`,`role`,`effort`,`joined`,`is_validated`,`description`,`created_at`,`updated_at`) VALUES (140331,3,'Member',15,'2014/12/22',0,null,'2016/12/13','2016/12/13');
...
INSERT INTO `exacutor`.`achievements`(`act_id`,`stu_id`,`date`,`position`,`description`,`created_at`,`updated_at`) VALUES (1,140392,'2016/10/25','Winner','Best Rotoracter of the Year','2016/12/01','2016/12/01');

INSERT INTO `exacutor`.`achievements`(`act_id`,`stu_id`,`date`,`position`,`description`,`created_at`,`updated_at`) VALUES (2,140392,'2016/06/30','Runners Up','Most outstanding panelist','2016/12/01','2016/12/01');

INSERT INTO `exacutor`.`achievements`(`act_id`,`stu_id`,`date`,`position`,`description`,`created_at`,`updated_at`) VALUES (2,140392,'2015/12/20','Second Runners Up','Most outstanding project','2016/12/01','2016/12/01');
