            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-10">
                        <h4 class="text-right"><strong>Rotaract Club</strong></h4></div>
                    <div class="col-lg-6 col-lg-offset-0 col-md-6 col-md-offset-0 col-sm-6 col-xs-10">
                        <h4 class="text-right">University of Moratuwa</h4></div>
                </div>
            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <div class="row">
                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><img class="img-circle" src="http://www.ultimatetech.org/file/2016/01/Verify-Facebook-Page-or-Profile.png" width="30" height="30"></div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-10">
                                                <h5><strong>Wishmitha Mendis</strong></h5></div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-5">
                                                <h5><strong>'14 Batch</strong></h5></div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-7">
                                                <h5><strong>Member </strong></h5></div>
                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-3">
                                                <h5><strong>12/10 </strong></h5></div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                                                <h5><strong>2015-12-13 </strong></h5></div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <h5>Winner </h5></div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <h5 class="text-right">2016-07-13 </h5></div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <p>Description goes here</p>
